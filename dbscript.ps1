...
function script-execute {
	...
	write-host "INFO: $sql_folders.length: "$sql_folders.length
write-host "INFO: $sql_folders.length1: "$sql_folders[0]

write-host "INFO: $sql_folders.length2: "$sql_folders[1]
